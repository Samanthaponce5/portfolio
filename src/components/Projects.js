        ...
        return(
          <div className='projects-area' id='projects'>
            ...
            <div class="carousel-item item-2">
              ...
              <div className='projectInfo'>
              <h1 >ShopMart</h1>
              <p className='describe'>An e-commerce site where you can shop around for many options of clothing.
               </p>
               <ul className='stack'>
                 <li>ReactJs</li>
                 <li>Redux</li>
               ...
               <button className='viewbtn' ><a href='https://github.com/Samanthaponce5/shopMart-front'>View Code</a></button>
               <button className='viewbtn' ><a href='https://shop-mart-us.netlify.app/'>Site</a></button>
            ...
            <div class="carousel-item item-3">
              ...
              <p className='describe'>An e-commerce site where you can shop around for many options of photography.
               ...
               <button className='viewbtn' ><a href='https://www.youtube.com/watch?v=SsByJf9NJJ4&t=3s'>Demo</a></button>
